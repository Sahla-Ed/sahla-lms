  ...
  return (
    <div className="from-background via-background to-muted/20 min-h-screen bg-gradient-to-br">
        ...
        <div className="container mx-auto max-w-4xl">
          <ScrollAnimate>
            <div className="space-y-8 text-center">
              ...
              <h1 className="from-primary to-primary/60 bg-gradient-to-r bg-clip-text text-5xl font-bold tracking-tight text-transparent md:text-6xl lg:text-7xl relative">
                {t('hero.title')}
                <Scribble shape="circle" className="-top-12 -left-12 w-32 h-32" color="blue" />
              </h1>
              <p className="text-muted-foreground mx-auto max-w-3xl text-xl leading-relaxed relative">
                {t('hero.description')}
                <Scribble shape="swoosh" className="-bottom-12 -right-8 w-24 h-24" color="orange" />
              </p>
            </div>
          </ScrollAnimate>
        </div>
      ...
      <section className="bg-muted/30 px-4 py-20 lg:py-32">
        <div className="container mx-auto max-w-4xl">
          <ScrollAnimate>
            <div className={cn("flex flex-col items-center gap-12", isRTL ? "md:flex-row-reverse" : "md:flex-row")}>
              <History className="text-primary h-32 w-32 lg:h-48 lg:w-48 flex-shrink-0" />
              <div className={cn("flex-grow", isRTL ? "text-right" : "text-left")}>
                <h2 className="mb-6 text-4xl lg:text-5xl font-bold">{t('story.title')}</h2>
      ...
      <section className="px-4 py-20 lg:py-32">
        <div className="container mx-auto max-w-5xl">
          <ScrollAnimate>
            <h2 className="mb-16 text-center text-4xl lg:text-5xl font-bold">{t('mission.title')}</h2>
          </ScrollAnimate>
