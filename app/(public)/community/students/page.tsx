...
export const metadata: Metadata = {
  ...
  description: "Connect with fellow learners, join study groups, and participate in discussions. The Sahla community is here to support your learning journey.",
};
