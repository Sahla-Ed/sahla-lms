...
export const metadata: Metadata = {
  ...
  description: "Form or join study groups to collaborate with other learners. Enhance your understanding and stay motivated together.",
};
...
export default function StudyGroupsPage() {
  return (
    <PlaceholderPage
      ...
      icon={<Group className="h-4 w-4 mr-2" />}
    />
  );
}
