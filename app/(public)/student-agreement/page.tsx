...
import { UserCheck, BookOpen, Award, Shield, CreditCard, MessageSquare, ChevronRight } from "lucide-react";
...
const sections = [
  {
    ...
    content: "Maintain respectful behavior and academic integrity in all interactions with fellow students, instructors, and platform content."
  },
  {
    icon: <BookOpen className="h-6 w-6 text-primary" />,
    title: "Learning Responsibilities", 
    content: "Complete coursework actively and engage meaningfully with the learning materials and community discussions."
  },
  {
    icon: <Award className="h-6 w-6 text-primary" />,
    title: "Certification Standards",
    content: "Work independently and honestly for valid certificates. All assessments must reflect your own understanding and effort."
  },
  {
    icon: <Shield className="h-6 w-6 text-primary" />,
    title: "Account Security",
    content: "Keep your login credentials secure and report any unauthorized access immediately to our support team."
  }
];
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center space-y-8">
            ...
            <p className="max-w-2xl mx-auto text-xl text-muted-foreground leading-relaxed">
              Your rights and responsibilities as a valued member of the Sahla learning community.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Essential principles that ensure a positive learning experience for everyone
            </p>
          </div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Access the help and resources you need for a successful learning journey
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="group hover:shadow-2xl transition-all duration-500 hover:scale-105 border-0 bg-gradient-to-br from-card to-accent/5">
              ...
              <CardContent className="text-center">
                <p className="text-muted-foreground mb-4">Get help when you need it most</p>
            ...
            <Card className="group hover:shadow-2xl transition-all duration-500 hover:scale-105 border-0 bg-gradient-to-br from-card to-accent/5">
              ...
              <CardContent className="text-center">
                <p className="text-muted-foreground mb-4">Best practices for success</p>
            ...
            <Card className="group hover:shadow-2xl transition-all duration-500 hover:scale-105 border-0 bg-gradient-to-br from-card to-accent/5">
              ...
              <CardContent className="text-center">
                <p className="text-muted-foreground mb-4">Learn about our certification process</p>
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-primary/5 to-primary/10">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Join thousands of learners who are already advancing their skills and careers with Sahla
          </p>
