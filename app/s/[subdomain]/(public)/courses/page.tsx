...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: `Explore Courses | ${tenant.name}`,
    description: `Browse expertly curated online courses on ${tenant.name} - designed to boost your skills and career.`,
  };
}
